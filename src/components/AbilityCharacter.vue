<template>
    <div class="ability-content">
        ...
        >
          ...
          <button v-if="spaStore.currentCharacter.abilities.length > 1" type="button" @click="deleteItem();" class="edit-item">
...
const deleteItem = () => {
  console.log("DELETING>.......... currentCharacter = ", spaStore.currentCharacter.charname)
  spaStore.currentCharacter.abilities.splice(props.itemIndex, 1);
  editing.value = false;
  spaStore.charUpdate()
}
...
const updateItemData = () => {
  ...
  if(!abilityTextInput.value.value){
    ...
    console.log("MESASAGE SET TO FALSE. currentCharacter.value.ability = ", ability.value)
    message.value = false;
    editing.value = false;
    spaStore.currentCharacter.abilities[props.itemIndex] = abilityTextInput.value.value;
...
onMounted(() => {
  if (!spaStore.currentCharacter.abilities[props.itemIndex]){
